...
const MoodBoardWorkspace = () => {
  ...
  const getCurrentImages = () => {
    if (isShowingPlaceholders) {
      return Array.from({ length: 8 }, (_, i) => `${import.meta.env.BASE_URL}${placeholderType}PlaceHolders/${i + 1}.png`);
    }
    return Array.from({ length: 8 }, (_, i) => `${import.meta.env.BASE_URL}${currentContentSet}/images/${i + 1}.png`);
  };
  ...
  const getCurrentLayouts = () => {
    ...
    return layoutNames.map(name => `${import.meta.env.BASE_URL}${currentContentSet}/layouts/${name}`);
  };
          ...
          <div className="mood-section">
            ...
            <div className="typography-grid">
              <div className="typography-item">
                <img src={`${import.meta.env.BASE_URL}typography/typ1-11.png`} alt="Typography 1" />
              </div>
              <div className="typography-item">
                <img src={`${import.meta.env.BASE_URL}typography/typ2-10.png`} alt="Typography 2" />
              </div>
              <div className="typography-item">
                <img src={`${import.meta.env.BASE_URL}typography/typ3.png`} alt="Typography 3" />
              </div>
              <div className="typography-item">
                <img src={`${import.meta.env.BASE_URL}typography/typ4.png`} alt="Typography 4" />
              </div>
            </div>
          </div>
          ...
          <div className="mood-section">
            ...
            <div className="icons-container">
              <div className="icon-item">
                <img src={`${import.meta.env.BASE_URL}icons/Kpi.png`} alt="KPI Icon" />
              </div>
              <div className="icon-item">
                <img src={`${import.meta.env.BASE_URL}icons/Kpi-1.png`} alt="KPI Icon 1" />
              </div>
              <div className="icon-item">
                <img src={`${import.meta.env.BASE_URL}icons/Kpi-2.png`} alt="KPI Icon 2" />
              </div>
              <div className="icon-item">
                <img src={`${import.meta.env.BASE_URL}icons/Kpi-3.png`} alt="KPI Icon 3" />
              </div>
            </div>
          </div>
        </div>
